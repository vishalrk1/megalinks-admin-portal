...
import { AnimepackColumn } from "./columns";
...
export const CellAction: React.FC<CellActionProps> = ({
    ...
    const onDelete = async () => {
        try{
            ...
            setLoading(true);
            await axios.delete(`/api/${params.userId}/animepacks/${data.id}`);
            router.refresh();
    ...
    return (
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem onClick={() => router.push(`/${params.userId}/animepacks/${data.id}`)}>
